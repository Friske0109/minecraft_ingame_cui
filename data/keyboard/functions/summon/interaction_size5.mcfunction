#> keyboard:summon/interaction_size5

$execute at @e[tag=keyboard_key_$(key)] run summon interaction ~0.075 ~-0.01 ~0.025 {Tags:["keyboard", "keyboard_interaction", "keyboard_interaction_$(key)"]}
