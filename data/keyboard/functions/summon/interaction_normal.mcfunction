#> keyboard:summon/interaction_normal

$execute at @e[tag=keyboard_key_$(key)] run summon interaction ~0.025 ~-0.01 ~0.025 {Tags:["keyboard", "keyboard_interaction", "keyboard_interaction_$(key)"]}
